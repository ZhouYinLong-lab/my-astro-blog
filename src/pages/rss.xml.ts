...
export async function GET(context: any) {
  ...
  const items = await Promise.all(
    sortedPosts.map(async (blog: CollectionEntry<"blog">) => {
      ...
      const coverURL = image ? new URL(image, context.site).toString() : undefined;
      ...
      return {
        ...
        content: `${content} <blockquote>This rendering was automatically generated by 寒柳别苑 Feed and may have formatting issues. For the best experience, please visit: <a href="${postURL}">${postURL}</a></blockquote>`,
        customData: `
        ${coverData}
